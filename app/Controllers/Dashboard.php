...
class Dashboard extends BaseController
{
    ...
    public function setNote()
    {
        if ($this->request->isAJAX()) {
            ...
            curl_setopt($ch, CURLOPT_URL, "https://idiomas.edutecno.cl/api/estadisticas/updateAchievement");
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
            curl_setopt($ch, CURLOPT_HEADER, true);
            curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
            curl_setopt($ch, CURLOPT_POST, true);
    ...
    public function setExperience()
    {
        if ($this->request->isAJAX()) {
            ...
            curl_setopt($ch, CURLOPT_URL, "https://idiomas.edutecno.cl/api/estadisticas/updateExperience");
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
            curl_setopt($ch, CURLOPT_HEADER, true);
            curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
            curl_setopt($ch, CURLOPT_POST, true);
